...
class Category(models.Model):
    ...
    Image = models.ImageField(
        verbose_name="Изображение", upload_to='category/')
    Color = models.CharField(
        verbose_name="Цвет (html color code)  #", max_length=50)
    Show_nav = models.CharField(max_length=50, choices=Show_nav_list,
                                default="Не отображать", verbose_name="Отображать в меню")
...
class Tag(models.Model):
    ...
    Visible_status = models.CharField(
        max_length=50, choices=Visible_status_list, default="Не отображать", verbose_name="Блок на главной")
...
class Product(models.Model):
    ...
    Images = models.ManyToManyField(
        ProductImage, verbose_name="Изображения товара", blank=True)
    ...
    Recommendation = models.CharField(
        max_length=50, choices=Recommendation_list, default="Не отображать", verbose_name="Рекомендации")
    Short_description = models.TextField(
        blank=True, verbose_name="Краткое описание карточки")
    Description = models.TextField(blank=True, verbose_name="Описание товара")
    Video = models.FileField(upload_to='product/video/', null=True, blank=True, validators=[
                             FileExtensionValidator(allowed_extensions=['MOV', 'avi', 'mp4', 'webm', 'mkv'])], verbose_name="Видеообзор")
...
class Banner(models.Model):
    ...
    Image = models.FileField(upload_to='banner/', null=True, blank=True, validators=[FileExtensionValidator(
        allowed_extensions=['JPEG', 'JPG', 'GIF', 'PNG', 'APNG', 'SVG', 'BMP', 'ICO'])], verbose_name="Изображение")
...
class Order(models.Model):
    ...
    Name_Sender = models.CharField(
        verbose_name="Имя отправителя", max_length=50)
    Phone_Sender = models.CharField(
        verbose_name="Телефон отправителя", max_length=50)
    Email_Sender = models.CharField(
        verbose_name="Email отправителя", max_length=50, blank=True)

    Products = models.TextField(verbose_name='Заказ')
    Delivery_type = models.CharField(
        max_length=50, choices=Delivery_type_list, verbose_name="Тип доставки")

    Name_Receiver = models.CharField(
        verbose_name="Имя получателя ", max_length=50)
    Phone_Receiver = models.CharField(
        verbose_name="Телефон получателя", max_length=50)
...
class Thanks(models.Model):
    ...
    Image = models.FileField(upload_to='thanks/', null=True, blank=True, validators=[FileExtensionValidator(
        allowed_extensions=['JPEG', 'JPG', 'GIF', 'PNG', 'APNG', 'SVG', 'BMP', 'ICO'])], verbose_name="Изображение")
